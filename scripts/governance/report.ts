...
async function main() {
  ...
  await setRole(await vault.getAddress(), wallet.address, ROLES.REPORTING_MANAGER, wallet);

  await vault.connect(wallet).processReport(addresses.base.wasabiUSDCERC4626);
}
main();
